...
const schema = z.object({
    ...
    startTime: z.string()
        .regex(/^(0?[1-9]|1[0-2]):([0-5][0-9])\s?(AM|PM)$/i, { message: "Start time must be in HH:MM AM/PM format." }),

    endTime: z.string()
        .regex(/^(0?[1-9]|1[0-2]):([0-5][0-9])\s?(AM|PM)$/i, { message: "End time must be in HH:MM AM/PM format." }),
});
        ...
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                <InputField
                    label="Date"
                    name="date"
                    type="date" // Assuming you want to use a date picker for the date input
                ...
                <InputField
                    label="Start Time"
                    name="startTime"
                    type="time" // Using text for time input; adjust as needed
