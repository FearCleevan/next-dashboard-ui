...
const schema = z.object({
    ...
    students: z.array(z.string()) // Assuming students are represented as an array of strings
        .nonempty({ message: "At least one student is required!" }),
        ...
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                <InputField
                    label="Students"
                    name="students"
                    defaultValue={data?.students.join(",")} // Joining for display, but consider handling as array on submit
                    register={register}
                />
                <InputField
                    label="Phone"
