...
const schema = z.object({
    username: z
        .string()
        .min(7, { message: "Username at least 7 Char long!" })
        .max(15, { message: "Username at most 15 Char long!" }),
    email: z.string().email({ message: "Invalid email address!" }),
    password: z.string().min(8, { message: "Password at least 7 Char long!" }),
    firstName: z.string().min(3, { message: "First Name is required!" }),
    lastName: z.string().min(3, { message: "Last Name is required!" }),
    phone: z.string().min(3, { message: "Phone No. is required!" }),
